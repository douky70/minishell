...
/*   Updated: 2019/04/02 17:08:07 by akeiflin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*ft_strreplace(char *src, char *toreplace,
								char *replacestr);
char			*ft_strlreplace(char *src, char *toreplace,
								char *replacestr, int nbrocc);
...
t_list			*ft_lstaddnew(t_list **alst, void const *content,
					size_t content_size);
